export const addExercise = "Add Exercise";
export const exerciseName = "Exercise Name";
export const primaryMuscleGroup = "Primary Muscle Group";
...
export const primarySecondaryCannotBeTheSame =
  "Primary and secondary muscle group can't be the same, please retry.";
